        ...
        experienceList: [
          {
            ...
            skills:
              "React.js, TypeScript, MobX,, Jest, Microfrontend with Webpack Module Federation, Git",
          },
          {
            title: "Garpix",
            ...
            skills:
              "React.js, JavaScript, TypeScript, SCSS, Redux, MobX, styled-components, Jest, Webpack, GraphQL, NestJS, PostgreSQL, Git",
          },
          {
            title: "Nike",
            data: "02.2020 - 06.2021",
            bullets: [
              "gереписал легаси код на React приложение",
              "разработал ReactJS - kit благодаря которому сильно ускорилось создание новых рекламных лендингов",
            ],
            link: "https://nike.com",
            skills: "React.js, JavaScript, Cascading Style Sheets (CSS)",
          },
        ],
      },
    },
